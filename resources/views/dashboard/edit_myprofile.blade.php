                                  ...
                                  <div class="row">
                                    <div class="col">
                                      <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="instagram" placeholder="@instagram" value="{{ old('instagram', auth()->user()->instagam) }}">
                                      </div>
                                    </div>
                                    <div class="col">
                                      <div class="form-group">
                                        <label>GitHub</label>
                                        <input class="form-control" type="text" name="github" placeholder="@github" value="{{ old('github', auth()->user()->github) }}">
                                      </div>
                                    </div>
                                  </div>
                                  <div class="row">
